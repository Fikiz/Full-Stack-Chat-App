...
const LeftSideBar = () => {
  ...
  const { userData, chatData, chatUser, setChatUser, messageId, setMessageId,chatVisible,setChatVisible } = useContext(AppContext);
    ...
    <div className={`ls ${chatVisible ? 'hidden' : ''}`}>
      <div className="ls-top">
        <div className="ls-nav">
          <img src={assets.fikiz} alt="" className='logo' /> chatApp
          <div className="menu">
            ...
            : chatData.map((item, index) => (
              <div onClick={() => setChat(item)} key={index} className={`friends ${item.messageSeen || item.messageId === messageId ? "" : "border"}`}>
                ...
                <div>
                  ...
                  <span className="lastMessage">{item.lastMessage || 'No message yet'}</span> {/* Check for undefined */}
                </div>
              </div>
            ))
          }
